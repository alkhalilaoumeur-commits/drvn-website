  ...
  return (
    <main>
      ...
      <section className="pt-40 md:pt-56 pb-20 md:pb-28">
        <Container>
          <Eyebrow>Selektiv</Eyebrow>

          <motion.h1
            variants={fadeUp}
            initial="initial"
            animate="animate"
            className="font-sans font-light text-[clamp(2.75rem,6.5vw,5.25rem)] leading-[1.02] tracking-[-0.02em] text-ink mb-12 max-w-[10ch]"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6">
            ...
            >
              <p className="font-sans text-lg text-secondary leading-[1.55] max-w-[50ch]">
                drvn Ventures ist die kleinste Säule des Studios. Wir nehmen jedes Jahr maximal drei externe Projekte an, die langfristig laufen sollen.
              </p>
            </motion.div>
        ...
        <Container>
          ...
          >
            <p className="font-sans text-lg text-secondary leading-[1.55]">
              Ventures ist für Unternehmen, die nicht nur eine Website oder ein fertiges Produkt brauchen, sondern einen Entwicklungspartner über einen längeren Zeitraum. Das kann ein internes Tool sein, das mit dem Unternehmen wächst. Eine Plattform, die neue Funktionen pro Quartal braucht. Oder ein technisches Vorhaben, das schrittweise entstehen muss.
            </p>
            <p className="font-sans text-lg text-secondary leading-[1.55]">
...
function VenturesForm() {
  ...
  function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    track(Events.KONTAKT_FORM_SUBMITTED, { source: 'ventures-anfrage' })
